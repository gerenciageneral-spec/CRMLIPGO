...
comment on table public.procesos_disciplinarios is
  'Solicitudes de medida disciplinaria y su trámite. La usuaria reporta y solicita; el empleador (la temporal) cita a descargos y decide. Ver scripts/179_add_procesos_disciplinarios.sql';
