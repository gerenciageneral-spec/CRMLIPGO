-- ============================================================================
-- FIX 2026-09-14 -- novedad_reportada no reflejaba la novedad propia de un
-- domingo (Descanso, Vacaciones, Incapacidad...) cuando esa misma semana
-- hubo una licencia no remunerada real en otro día -- la tapaba con
-- "38- Licencia no remunerada- Deducción" aunque el pago ya estuviera
-- correcto. Caso real: ELKIN DAVID DIAZ SANDOVAL (ID2), domingo 06-sep-2026,
-- novedad "Descanso", pagado $58.363,50 (día completo, correcto) pero
-- mostraba la novedad de licencia en vez de "Descanso" en Revisión de Nómina.
--
-- Extraído del dump vivo de la vista (scripts/050_vistas_financieras.sql,
-- líneas 14-882, generado 2026-09-11) para partir de la definición
-- EXACTA que está corriendo hoy en producción -- ver el único cambio real
-- más abajo, comentario "FIX 2026-09-14" junto a `novedad_reportada`.
